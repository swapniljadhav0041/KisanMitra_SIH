...
const instrumentCategories = [
  { slug: 'tractors_vehicles', label: 'Tractors & Vehicles' },
  { slug: 'tillage_preparation', label: 'Tillage & Land Preparation' },
  { slug: 'sowing_planting', label: 'Sowing & Planting' },
  { slug: 'irrigation_water', label: 'Irrigation & Water' },
  { slug: 'crop_care', label: 'Crop Care' },
  { slug: 'harvesting', label: 'Harvesting' },
  { slug: 'tools_accessories', label: 'Tools & Accessories' },
];

export default function AddInstrumentProduct() {
  ...
  const [form, setForm] = useState({
    ...
    location: '',
    pincode: '',
    category_slug: 'tractors_vehicles',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Instrument product added successfully');
    ...
    <>
      ...
      <main style={styles.page}>
        <div style={styles.container}>
          <h1 style={styles.title}>Add Instrument Product</h1>
